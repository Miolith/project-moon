...
function rooms:5/miniroom2

# Mini game room 3 ( laser )

execute as @e[type=area_effect_cloud,x=322,y=72,z=128,dx=0,dy=0,dz=-1] at @s run execute as @e[type=marker,tag=laser_post,limit=1,sort=nearest] at @s run function puzzle:laser/receive
