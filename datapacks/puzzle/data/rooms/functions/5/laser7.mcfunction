...
execute store success score #laser_finish var if score #laser_temp2 var matches 1 if score #laser1 var matches 1 if score #laser2 var matches 1 if score #laser3 var matches 1 if score #laser4 var matches 1 if score #laser5 var matches 1 if score #laser6 var matches 1 if score #laser7 var matches 1 if score #laser8 var matches 1 run function rooms:5/laser_opendoor

execute if score #laser_temp2 var matches 1 if score #laser_finish var matches 0 run function rooms:5/laser_reset
...
execute if score #laser_temp3 var matches 1 if score #laser8 var matches 0 run schedule function rooms:5/laser8 20t
execute if score #laser_temp3 var matches 1 if score #laser8 var matches 1 run function rooms:5/laser_reset
...
execute if entity @e[type=turtle,x=351.5,y=70,z=172.5,distance=..1.5] as a4af7ec6-b7c8-4e68-a97b-f5d2a5829ea4 at @s run function rooms:5/laser_loop
