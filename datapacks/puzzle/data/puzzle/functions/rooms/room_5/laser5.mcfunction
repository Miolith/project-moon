...
execute if score #laser_temp1 var matches 1 if score #laser4 var matches 0 run schedule function puzzle:rooms/room_5/laser4 20t
execute if score #laser_temp1 var matches 1 if score #laser4 var matches 1 run function puzzle:rooms/room_5/laser_reset
...
execute if score #laser_temp2 var matches 1 if score #laser2 var matches 0 run schedule function puzzle:rooms/room_5/laser2 20t
execute if score #laser_temp2 var matches 1 if score #laser2 var matches 1 run function puzzle:rooms/room_5/laser_reset
...
execute if entity @e[type=turtle,x=351.5,y=70,z=167.5,distance=..1.5] as a4af7ec6-b7c8-4e68-a97b-f5d2a5829ea4 at @s run function puzzle:rooms/room_5/laser_loop
